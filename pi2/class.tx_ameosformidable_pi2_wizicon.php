 ...
 */
class ameos_formidable_pi2_wizicon {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ameos_formidable/pi2/class.ameos_formidable_pi2_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ameos_formidable/pi2/class.ameos_formidable_pi2_wizicon.php']);
}
