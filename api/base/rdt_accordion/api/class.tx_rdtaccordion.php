...
class tx_rdtaccordion extends formidable_mainrenderlet {
	
	var $aLibs = array(
		"rdt_accordion_lib" => "res/js/accordion-fixed.js",
		"rdt_accordion_class" => "res/js/rdt_accordion.js",
	);
...
STYLE;
		...
		return array(
			"__compiled" => "<div id='" . $this->_getElementHtmlId() . "'>" . $sCompiledChilds . "</div>",
			"childs" => $aChilds,
		);
	}
	...
	if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/base/rdt_accordion/api/class.tx_rdtaccordion.php"])	{
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/base/rdt_accordion/api/class.tx_rdtaccordion.php"]);
	}
?>