...
class tx_rdtjstree extends formidable_mainrenderlet {
	...
	function _render() {
		...
		$this->oForm->oJs->loadScriptaculousDragDrop();
		
		$this->oForm->additionalHeaderDataLocalStylesheet(
			$this->sExtPath . 'res/lib/css/tree.css',
			"rdt_jstree_lib_css"
		);
...
*/
	...
	if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/base/rdt_jstree/api/class.tx_rdttext.php"])	{
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/base/rdt_jstree/api/class.tx_rdttext.php"]);
	}
?>