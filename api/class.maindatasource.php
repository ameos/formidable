<?php
	...
	class formidable_maindatasource extends formidable_mainobject {
		...
		function writable() {
			return $this->defaultFalse("/writable");
		}
		...
		function dset_hasFlexibleStructure() {
			...
			return $this->defaultFalse("/flexiblestructure");
		}

		function dset_alwaysNeedsToBeWritten() {
			return $this->defaultFalse("/alwaysneedstobewritten");
		}
	...
	if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/class.maindatasource.php"])	{
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/class.maindatasource.php"]);
	}
?>